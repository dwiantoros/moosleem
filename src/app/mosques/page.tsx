        ...
        {loading ? (
          ...
          <section className="glass-panel rounded-[1.75rem] p-6 sm:p-7">
            <div className="rounded-2xl border border-amber-300/60 bg-gradient-to-br from-amber-50 to-orange-50 p-5 dark:border-amber-700/40 dark:from-amber-900/20 dark:to-orange-900/10">
              ...
              <h2 className="mt-2 text-xl font-semibold text-slate-900 dark:text-slate-100">Aktifkan lokasi untuk melihat masjid terdekat</h2>
              <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
                Kami belum bisa menampilkan data masjid karena akses lokasi belum diizinkan. Aktifkan izin lokasi di browser, lalu muat ulang halaman ini.
              </p>
              <button
                type="button"
